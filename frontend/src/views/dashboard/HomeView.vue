<template>
  <div>
    ...
    <el-row :gutter="16" style="margin-top:16px">
      <el-col :span="12"><el-card>平均满意度<div class="num">{{ Number(orderStats.avgSatisfaction || 0).toFixed(2) }}</div></el-card></el-col>
      <el-col :span="12"><el-card>低分工单数(≤2分)<div class="num">{{ orderStats.lowScoreCount || 0 }}</div></el-card></el-col>
    </el-row>
