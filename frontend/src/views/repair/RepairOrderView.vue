    ...
    <el-table :data="list" style="margin-top:12px">
      ...
      <el-table-column label="操作" width="360">
        <template #default="s">
          ...
          <el-button v-if="isAdmin && s.row.status==='待处理'" link @click="assign(s.row)">分配</el-button>
          <el-button v-if="isAdmin || isMaintainer" link @click="changeStatus(s.row)">修改状态</el-button>
