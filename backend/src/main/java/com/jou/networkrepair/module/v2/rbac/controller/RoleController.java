...
public class RoleController {
    ...
    /** 分页查询（支持关键字与状态筛选）。 */
    @GetMapping("/page")
    public ApiResult<PageDataVO<Role>> page(@Validated RolePageDTO dto) {
    ...
    /** 新增记录。 */
    @PostMapping
    public ApiResult<Void> create(@RequestBody Role entity) {
    ...
    /** 更新记录。 */
    @PutMapping("/{id}")
    public ApiResult<Void> update(@PathVariable Long id, @RequestBody Role entity) {
